...
class avvo(scrapy.Spider):
	...
	def parse_profile(self, response):
		...
		if check == '':
			...
			item['Avatar'] = response.xpath('//div[contains(@class, "v-lawyer-card-wrapper")]//img/@src').extract_first()
			...
			item['Avatar'] = response.xpath('//div[contains(@class, "downgraded-card-body")]//img/@src').extract_first()
